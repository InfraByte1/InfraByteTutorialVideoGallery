export const category = [
        ...
        items: [
          {
            id: 1,
            title: "Dashboard",
            categoryKey: "Permissions.WebPermissions.Dashboard.Dashboard",
            thumbnails: [
              {
                title: "Thumbnail 7",
  ...
  },
  {
    ...
    categoryKey: "Permissions.WebPermissions.JobBookings",
    subcategories: [
      {
        subcategoryId: 4,
        ...
        items: [
          {
            id: 7,
            title: "All cars",
            categoryKey: "Permissions.WebPermissions.JobBookings.AllCar",
            thumbnails: [],
          },
          {
            id: 8,
            title: "Tow Records",
            categoryKey: "Permissions.WebPermissions.JobBookings.TowRecords",
            thumbnails: [],
          },
          {
            id: 9,
            title: "Auctions",
            categoryKey: "Permissions.WebPermissions.JobBookings.Auction",
            thumbnails: [],
          },
          {
            id: 10,
            title: "Jobs",
            categoryKey: "Permissions.WebPermissions.JobBookings.Job",
            thumbnails: [],
          },
          {
            id: 11,
          ...
          },
          {
            id: 12,
            title: "Quotes",
            categoryKey: "Permissions.WebPermissions.JobBookings.Quote",
            thumbnails: [],
          },
          {
            id: 13,
          ...
          },
          {
            ...
            categoryKey: "Permissions.WebPermissions.JobBookings.InquirySystem",
            thumbnails: [
              {
                title: "Thumbnail 7",
                url: "https://via.placeholder.com/150",
          ...
          },
          {
            id: 20,
            title: "Car Referral",
            categoryKey: "Permissions.WebPermissions.JobBookings.CarReferral",
            thumbnails: [
              {
                title: "Thumbnail 7",
                url: "https://via.placeholder.com/150",
